/**
 * AdminAppShell Component
 * 
 * Layout shell specifically for admin/DWP users.
...
import { BarChart3, Users, MapPin, Settings, FileText, Shield } from "lucide-react"
  ...
  const navLinks = [
    {
      label: "Dashboard",
      href: "/staff/dwp",
      icon: <BarChart3 className="h-5 w-5 flex-shrink-0" aria-hidden="true" />,
    },
    {
      label: "Users",
    ...
    {
      label: "Regions",
      href: "/staff/admin/regions",
      icon: <MapPin className="h-5 w-5 flex-shrink-0" aria-hidden="true" />,
    },
    {
      label: "Settings",
